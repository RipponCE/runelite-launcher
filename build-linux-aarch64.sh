...
chmod 644 build/libs/Veskare.jar

cp native/build-aarch64/src/Veskar build/linux-aarch64/
cp build/libs/Veskar.jar build/linux-aarch64/
...
# Symlink AppRun -> Veskar
ln -s Veskar AppRun

# Ensure Veskar is executable to all users
chmod 755 Veskar
popd
