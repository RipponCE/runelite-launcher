...
cp native/build-x64/src/Release/Veskar.exe build/win-x64/
cp build/libs/Veskar.jar build/win-x64/
...
echo Veskar.exe 64bit sha256sum
sha256sum build/win-x64/Veskar.exe

dumpbin //HEADERS build/win-x64/Veskar.exe
