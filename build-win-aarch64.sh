...
sha256sum build/libs/Veskar.jar
...
cp native/build-aarch64/src/Release/Veskar.exe build/win-aarch64/
cp build/libs/Veskar.jar build/win-aarch64/
...
echo Veskar.exe aarch64 sha256sum
sha256sum build/win-aarch64/Veskar.exe

dumpbin //HEADERS build/win-aarch64/Veskar.exe
