...
cp native/build-x86/src/Release/Veskar.exe build/win-x86/
cp build/libs/Veskar.jar build/win-x86/
...
echo Veskar.exe 32bit sha256sum
sha256sum build/win-x86/Veskar.exe

dumpbin //HEADERS build/win-x86/Veskar.exe
